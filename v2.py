...
class Scheduler:
    ...
    def __init__(self, crcs: List[str], year: int = time.strptime(time.ctime()).tm_year, allow_async: List[bool] = True) -> None:
        self.data = {ID: []}
...
if __name__ == '__main__':
    ...
    allow_async = [False, False, False]
    sch = Scheduler(crcs, 2021, allow_async)
    timePrefnsFall = [1200]
